...
import { Block, Topic, Tag, StudyExercise, RepetitionExercise, CheckExercise, DataVersion } from "../models/index.js";
...
const versionController = new GetDataController(DataVersion);
...
router.get("/studyexercise-data", studyExerciseDataController.getExercises.bind(studyExerciseDataController));
router.get("/repetitionexercise-data", repetitionExerciseDataController.getExercises.bind(repetitionExerciseDataController));
router.get("/checkexercise-data", checkExerciseDataController.getExercises.bind(checkExerciseDataController));
router.get("/topics-with-tags", topicWithTagDataController.getTopicsWithTags.bind(topicWithTagDataController));

router.get("/version", versionController.getLatestDataVersion.bind(versionController));
